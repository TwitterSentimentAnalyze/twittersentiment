...
```
  ...
  It seems that both parties are moving in the general same direction although the magnitude is different. It is reasonable to observe that politicians from both parties react similarly for the same news. 
