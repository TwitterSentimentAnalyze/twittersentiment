...
2) The celebrities' score change is much more dramatic than the medical's, and celebrities' sentiment seem to be the most positive among all groups'. 

3) Although medical's and politicians' sentiment seem to be fluctuating quite a bit because the graph looks that way, but as will be shown in section 5.2.3, the change is not dramatic if we take into account the actual score values. 
