...
```{r}
sorted_newsmedia_accounts <- temp %>% arrange(desc(followers_count)) 
newsmedia <- sorted_newsmedia_accounts$screen_name[1:10] # top 10 newsmedia account
