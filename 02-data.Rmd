# Data sources
  ...
  All three of the team members contributed to collecting data. Alex ~, Elin collected top 10 celebrities list ranked by the number of followers (Ref: https://socialblade.com/twitter/top/100), and Kevin found top 100 most-followed medical Twitter accounts. (Ref: https://emedcert.com/blog/top-healthcare-twitter-accounts-to-follow)
  ...
  In addition, there are numerous unnecessary or insignificant features in the dataset collected, so we performed data cleaning in the following chapter (3 Data Transformation)
